...
import { deleteBanner, fetchBanners } from '../../Store/Slider/slider';

export default function SliderTable({setIsModalOpen , setSelectedBanner}) {
                  ...
                  >
                    <td className="p-2 flex gap-2 items-center">
                      <img
                        ...
                        alt="admin"
                        loading="lazy"
                        className="w-90 h-28 rounded-md"
                      />
                    </td>
                    <td className="p-5 mt-[10px]">
                        <button
